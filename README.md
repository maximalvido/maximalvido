...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Solidity-7C3AE9?style=for-the-badge&logo=solidity&logoColor=white" alt="Solidity" />
</div>
...
**June 2017 – August 2024 | Córdoba, Argentina**
...
### Co-Founder @ Wetokie
**August 2022 – September 2023 | Córdoba, Argentina**
...
**April 2015 – November 2017 | Córdoba, Argentina**

- **Backend & frontend optimization** for enterprise and gaming systems → 30% improvement in load times and API performance
- **Interactive UIs and analytics tools** (Angular, Durandal.js, Knockout.js, D3.js) → streamlined data processing for 300+ internal users
- **Engine tools optimization** (C++, C#, ActionScript) for Ignite Engine → reduced data retrieval load times from 18 hours to 10 minutes
...
### Web3 & Blockchain
**Solidity** ERC-20/721/1155/, tokenization, governance, ERC-4337, EIP-7702.
**Chains**: EVM (Ethereum, Arbitrum, Base, BSC, Monad, Polygon), and Solana
**Indexing**: Subsquid, The Graph
**Tools**: Foundry, Hardhat, Anvil, Viem.js, Ethers.js, Web3.js, Tenderly, Moralis, Birdeye, Bloxroute, JITO, and more.

### AI & Automation
**AI Agent Orchestration** (A2A, MCP)
**API Integration**: Openrouter, OpenAI, Claude, Gemini
**Agentic Workflows**: CrewAI & n8n
**Prompt Engineering**
...
✅ **0→1 Product Delivery** | **Founding Engineer roles** | **CTO-level architecture**

✅ **Web3 / DeFi / MEV** | **High-frequency systems** | **Real-time data pipelines**

✅ **Microservices** | **Event-driven systems** | **Multi-chain integration**

✅ **Team leadership** | **Cross-functional coordination** | **Technical strategy**

✅ **Smart contracts** | **Tokenization protocols** | **RWA infrastructure**

✅ **Performance optimization** | **Cost reduction** | **Production hardening**

---

## 🔗 Connect

- **Email**: maxi@clawstudios.com | +34 662 544 167
- **Website**: https://maximilianomalvido.com
- **LinkedIn**: https://linkedin.com/in/maximiliano-malvido
- **GitHub**: https://github.com/maximalvido
